...
namespace ChiaSeDuLich.Areas.Admin.Controllers
{
    public class CommentController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CommentId,CommentContent,InforShareId,UserId,UserName")] Comment comment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CommentId,CommentContent,InforShareId,UserId,UserName")] Comment comment)
        {
            if (ModelState.IsValid)
            {
